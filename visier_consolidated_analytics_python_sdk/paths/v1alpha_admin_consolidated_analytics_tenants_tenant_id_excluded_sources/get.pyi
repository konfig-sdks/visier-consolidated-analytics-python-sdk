...
class BaseApi(api_client.Api):
    ...
    def _list_excluded_sources_mapped_args(
        self,
    ...
    async def _alist_excluded_sources_oapg(
        self,
    ...
    def _list_excluded_sources_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListExcludedSourcesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_excluded_sources(
        self,
        tenant_id: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._list_excluded_sources_mapped_args(
            tenant_id=tenant_id,
        )
        return await self._alist_excluded_sources_oapg(
    ...
    def list_excluded_sources(
        ...
        return self._list_excluded_sources_oapg(
            query_params=args.query,
        )

class ListExcludedSources(BaseApi):
    ...
    async def alist_excluded_sources(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_excluded_sources(
            tenant_id=tenant_id,
            **kwargs,
        )
        if validate:
    ...
    def list_excluded_sources(
        ...
        raw_response = self.raw.list_excluded_sources(
            tenant_id=tenant_id,
        )
        if validate:
            return ConsolidatedAnalyticsAPIExcludedSourcesListDTOPydantic(**raw_response.body)
