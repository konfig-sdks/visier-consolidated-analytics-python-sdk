...
class BaseApi(api_client.Api):
    ...
    def _remove_excluded_sources_mapped_args(
        self,
    ...
    async def _aremove_excluded_sources_oapg(
        self,
    ...
    def _remove_excluded_sources_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RemoveExcludedSourcesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_excluded_sources(
        self,
        excluded_sources: typing.Optional[ExcludedSourcesBodyExcludedSources] = None,
        tenant_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._remove_excluded_sources_mapped_args(
            excluded_sources=excluded_sources,
            tenant_id=tenant_id,
        )
        return await self._aremove_excluded_sources_oapg(
            body=args.body,
    ...
    def remove_excluded_sources(
        ...
        return self._remove_excluded_sources_oapg(
            body=args.body,
            query_params=args.query,
        )

class RemoveExcludedSources(BaseApi):
    ...
    async def aremove_excluded_sources(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_excluded_sources(
            excluded_sources=excluded_sources,
            tenant_id=tenant_id,
            **kwargs,
        )
    ...
    def remove_excluded_sources(
        ...
        raw_response = self.raw.remove_excluded_sources(
            excluded_sources=excluded_sources,
            tenant_id=tenant_id,
        )
        if validate:
