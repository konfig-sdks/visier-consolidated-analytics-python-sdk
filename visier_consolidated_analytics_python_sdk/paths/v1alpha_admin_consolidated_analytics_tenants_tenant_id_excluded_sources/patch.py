...
class BaseApi(api_client.Api):
    ...
    def _add_excluded_sources_mapped_args(
        self,
    ...
    async def _aadd_excluded_sources_oapg(
        self,
    ...
    def _add_excluded_sources_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddExcludedSourcesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_excluded_sources(
        self,
        excluded_sources: typing.Optional[ExcludedSourcesBodyExcludedSources] = None,
        tenant_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._add_excluded_sources_mapped_args(
            excluded_sources=excluded_sources,
            tenant_id=tenant_id,
        )
        return await self._aadd_excluded_sources_oapg(
            body=args.body,
    ...
    def add_excluded_sources(
        ...
        return self._add_excluded_sources_oapg(
            body=args.body,
            query_params=args.query,
        )

class AddExcludedSources(BaseApi):
    ...
    async def aadd_excluded_sources(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_excluded_sources(
            excluded_sources=excluded_sources,
            tenant_id=tenant_id,
            **kwargs,
        )
    ...
    def add_excluded_sources(
        ...
        raw_response = self.raw.add_excluded_sources(
            excluded_sources=excluded_sources,
            tenant_id=tenant_id,
        )
        if validate:
