...
class BaseApi(api_client.Api):
    ...
    def _add_source_tenants_mapped_args(
        self,
    ...
    async def _aadd_source_tenants_oapg(
        self,
...
class AddSourceTenantsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_source_tenants(
        self,
        tenant_codes: typing.Optional[TenantCodeBodyTenantCodes] = None,
        tenant_id: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._add_source_tenants_mapped_args(
            tenant_codes=tenant_codes,
            tenant_id=tenant_id,
            limit=limit,
        )
        return await self._aadd_source_tenants_oapg(
            body=args.body,
    ...
    def add_source_tenants(
        ...
        return self._add_source_tenants_oapg(
            body=args.body,
            query_params=args.query,
        )

class AddSourceTenants(BaseApi):
    ...
    async def aadd_source_tenants(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_source_tenants(
            tenant_codes=tenant_codes,
            tenant_id=tenant_id,
            limit=limit,
            **kwargs,
    ...
    def add_source_tenants(
        ...
        raw_response = self.raw.add_source_tenants(
            tenant_codes=tenant_codes,
            tenant_id=tenant_id,
            limit=limit,
        )
