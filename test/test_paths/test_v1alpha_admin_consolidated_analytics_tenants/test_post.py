...
from visier_consolidated_analytics_python_sdk.paths.v1alpha_admin_consolidated_analytics_tenants import post
from visier_consolidated_analytics_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1alphaAdminConsolidatedAnalyticsTenants(ApiTestMixin, unittest.TestCase):
    """
    V1alphaAdminConsolidatedAnalyticsTenants unit test stubs
